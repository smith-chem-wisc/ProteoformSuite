...
namespace Test
{
    ...
    public class TestFindRawComponentsAndNeuCodePairs
    {
        ...
        public void testFindRawNeuCodePairsMethod()
        {
            ...
            NeuCodePair neucode_pair = SaveState.lollipop.raw_neucode_pairs.Where(i => i.id_heavy == inFileId + "_5" && i.id_light == inFileId + "_1").First();
            ...
            neucode_pair = SaveState.lollipop.raw_neucode_pairs.Where(i => i.id_heavy == inFileId + "_122" && i.id_light == inFileId + "_57").First();
