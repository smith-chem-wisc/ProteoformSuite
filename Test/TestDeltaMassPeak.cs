...
namespace Test
{
    ...
    public class TestDeltaMassPeak
    {
        ...
        public void TestDeltaMassPeakConstructor()
        {
            ...
            Lollipop.et_average_noise_level = (double)theList.Count / ((Lollipop.et_high_mass_difference - Lollipop.et_low_mass_difference) / Lollipop.peak_width_base);
            ...
            Assert.AreEqual(Math.Round(.00299991, 4), Math.Round(deltaMassPeak.peak_group_fdr, 4));
