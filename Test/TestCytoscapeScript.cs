...
namespace Test
{
    ...
    class TestCytoscapeScript
    {
        ...
        public void nodes_table_gives_meaningful_modified_theoreticals2()
        {
            ...
            ModificationWithMass m = new ModificationWithMass("oxidation", new Tuple<string, string>("", ""), motif, ModificationSites.K, 1, new Dictionary<string, IList<string>>(), new List<double>(), new List<double>(), new List<double>(), "");
        ...
        public void nodes_table_gives_meaningful_case_insensitive_unmodified_theoreticals()
        {
            ...
            ModificationWithMass m = new ModificationWithMass(mod_title, new Tuple<string, string>("N/A", mod_title), motif, ModificationSites.K, 0, new Dictionary<string, IList<string>>(), new List<double>(), new List<double>(), new List<double>(), "");
