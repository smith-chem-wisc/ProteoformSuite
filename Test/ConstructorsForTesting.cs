...
namespace Test
{
    public class ConstructorsForTesting
    {
        ...
        public static TheoreticalProteoform make_a_theoretical()
        {
            ...
            ModificationWithMass m = new ModificationWithMass(mod_title, new Tuple<string, string>("", mod_title), motif, TerminusLocalization.Any, 1, new Dictionary<string, IList<string>>(), new List<double>(), new List<double>(), "");
        ...
        public static ModificationWithMass get_modWithMass(string id, double mass)
        {
            ModificationMotif motif;
            ModificationMotif.TryGetMotif("K", out motif);
            ModificationWithMass m = new ModificationWithMass(id, new Tuple<string, string>("", ""), motif, TerminusLocalization.Any, mass, new Dictionary<string, IList<string>>(), new List<double>(), new List<double>(), "");
            return m;
        }
