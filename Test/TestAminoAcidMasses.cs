...
namespace Test
{
    ...
    public class TestAminoAcidMasses
    {
        ...
        {
            var MassesList1 = new AminoAcidMasses(true, true, false, true, false);
            Assert.AreEqual(147.0353996, MassesList1.AA_Masses['M']);
            Assert.AreEqual(160.030649, MassesList1.AA_Masses['C']);

            var MassesList2 = new AminoAcidMasses(false, false, false, true, false);
        ...
        public void TestAminoAcidMassesDefaultLysine()
        {
            ...
            var MassesList2 = new AminoAcidMasses(true, true, true, false, false);
            Assert.Less(MassesList2.AA_Masses['K'], 136.109162);
            var MassesList3 = new AminoAcidMasses(true, true, false, false, true);
