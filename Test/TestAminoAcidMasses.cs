...
namespace Test
{
    ...
    public class TestAminoAcidMasses
    {
        ...
        {
            var MassesList1 = new AminoAcidMasses(true, false,false);
            Assert.AreEqual(131.040485, MassesList1.AA_Masses['M']);
            Assert.AreEqual(160.030649, MassesList1.AA_Masses['C']);

            var MassesList2 = new AminoAcidMasses(false, false,false);
        ...
        {
            var MassesList1 = new AminoAcidMasses(true,true,false);
            Assert.AreEqual(136.109162, MassesList1.AA_Masses['K']);
            var MassesList2 = new AminoAcidMasses(true, false,false);
