...
namespace ProteoWPFSuite
{
    public class DisplayDeltaMassPeak : DisplayObject
    {
        ...
        public static void FormatPeakListGridView(System.Windows.Forms.DataGridView dgv, bool mask_mass_shifter)
        {
            ...
            foreach (System.Windows.Forms.DataGridViewColumn column in dgv.Columns) { column.Visible = false; }
