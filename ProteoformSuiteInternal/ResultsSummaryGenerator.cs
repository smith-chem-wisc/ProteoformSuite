...
namespace ProteoformSuiteInternal
{
    public static class ResultsSummaryGenerator
    {
        ...
        public static string counts()
        {
            ...
            if (Lollipop.ef_relations.Count > 0) report += Lollipop.ef_relations.Average(d => d.Value.Count).ToString() + "\tTotal Experimental-False Pairs" + Environment.NewLine + Environment.NewLine;
            else report += Environment.NewLine;
