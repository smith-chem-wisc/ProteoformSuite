...
namespace ProteoformSuiteInternal
{
    public static class ResultsSummaryGenerator
    {
        ...
        public static string counts()
        {
            ...
            report += Lollipop.ef_relations.Count <= 0 ? Environment.NewLine : Lollipop.ef_relations.Average(d => d.Value.Count).ToString() + "\tAverage Experimental-False Pairs" + Environment.NewLine + Environment.NewLine;
