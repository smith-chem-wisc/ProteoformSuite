...
namespace ProteoformSuiteInternal
{
    public class MsScan
    {
        ...
        public MsScan(int ms_order, int scan_number, string filename, double retention_time, double injection_time, double TIC, double[] noises, double[] peak_x, double [] peak_y)
        {
